...
python /lustre/fs4/risc_lab/scratch/jyeung/for_Hide/ATAC_deep_sequencing_Novogene_10112024/Centromeric_Repeat_Seq/count_kmers_in_fastq_verbose/count_kmers_in_fastq_verbose.py \
  -k /lustre/fs4/risc_lab/scratch/jyeung/for_Hide/ATAC_deep_sequencing_Novogene_10112024/Centromeric_Repeat_Seq/FCR_monomers/FCR_15mers_seqonly.fasta \
  -f "$INPUT" \
  -o "$OUT_COUNT" \
  -d "$OUT_DETAIL"
