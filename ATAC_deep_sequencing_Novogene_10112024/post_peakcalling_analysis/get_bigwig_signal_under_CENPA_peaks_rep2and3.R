...
save(overlap_results, file = "/lustre/fs4/risc_lab/scratch/jyeung/for_Hide/ATAC_deep_sequencing_Novogene_10112024/workspaces/CENPA_peaks_rep2_signal_bw.RData")
...
save(summed_score, file = "/lustre/fs4/risc_lab/scratch/jyeung/for_Hide/ATAC_deep_sequencing_Novogene_10112024/workspaces/CENPA_peaks_rep2_summed_score.RData")

# Add scores to CENPA peaks and save
CENPA_peaks_rep2 <- CENPA_peaks
CENPA_peaks_rep2$score <- unlist(summed_score)
save(CENPA_peaks_rep2, file = "/lustre/fs4/risc_lab/scratch/jyeung/for_Hide/ATAC_deep_sequencing_Novogene_10112024/workspaces/CENPA_peaks_rep2_GR_score.RData")
...
save(overlap_results, file = "/lustre/fs4/risc_lab/scratch/jyeung/for_Hide/ATAC_deep_sequencing_Novogene_10112024/workspaces/CENPA_peaks_rep3_signal_bw.RData")
...
save(summed_score, file = "/lustre/fs4/risc_lab/scratch/jyeung/for_Hide/ATAC_deep_sequencing_Novogene_10112024/workspaces/CENPA_peaks_rep3_summed_score.RData")

# Add scores to CENPA peaks and save
CENPA_peaks_rep3 <- CENPA_peaks
CENPA_peaks_rep3$score <- unlist(summed_score)
save(CENPA_peaks_rep3, file = "/lustre/fs4/risc_lab/scratch/jyeung/for_Hide/ATAC_deep_sequencing_Novogene_10112024/workspaces/CENPA_peaks_rep3_GR_score.RData")
