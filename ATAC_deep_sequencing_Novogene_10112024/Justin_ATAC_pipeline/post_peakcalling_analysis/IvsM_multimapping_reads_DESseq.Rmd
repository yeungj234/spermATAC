...
pheatmap(rlog_IvsM.sigMat, cluster_cols = F, cluster_rows = T, annotation_col = IvsM.metaData[ ,-c(1,3)], annotation_row = anno.IvsM.sigPeaks_df, annotation_colors = hm_cols, show_rownames = F, breaks = seq(100, 10000, length.out = 100), colorRampPalette(brewer.pal(n = 7, name ="Reds"))(100), main=paste0("Significant Peaks:", nrow(rlog_IvsM.sigMat)))
dev.off()
